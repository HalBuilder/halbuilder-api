 ...
 *
 * Implementing this interface allows an object to assert the validity of a resources structure (required fields), business data
 * (duplicate data) or any other contractual concept.
 */
